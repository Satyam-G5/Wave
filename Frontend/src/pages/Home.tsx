  ...
  return (
    <div className='h-screen w-screen bg-custom '>
      ...
      <div className='flex md:flex-row flex-col justify-around'>
        <div className='md:flex md:flex-col mt-44 md:w-[90vh] w-screen'>
          <h3 className='md:text-3xl text-xl text-slate-600 font-semibold mb-4 w-[80vh]'>Host your Web Meetings</h3>
